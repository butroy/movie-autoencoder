...
#print(arguments)
activation_functions = ['relu','elu','sigmoid','tanh','selu']
train_loss_all = {}
test_loss_all = {}
for function in activation_functions:
    ...
    with tf.Graph().as_default():
        ...
        train_op, train_loss_op=model._optimizer(x_train,function)
        pred_op, test_loss_op=model._validation_loss(x_train_infer, x_test,function)
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(arguments['num_epoch']):
                ...
                test_loss_summary.append(test_loss/arguments['num_samples'])
                train_loss=0
                test_loss=0
    train_loss_all[function] = train_loss_summary
    test_loss_all[function] = test_loss_summary
